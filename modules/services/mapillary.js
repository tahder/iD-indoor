...
import { ChangeTags } from '../actions/change_tags';
...
export function init() {
	...
	mapillary.setImageForSelection = function(context) {
		...
		for(var i=0; i < selection.length; i++) {
			...
			newTags.mapillary = mapillary.image;
			context.perform(ChangeTags(selection[i], newTags), t('operations.change_tags.annotation'));
		}
	};
